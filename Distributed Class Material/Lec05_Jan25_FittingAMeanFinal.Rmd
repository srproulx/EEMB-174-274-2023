...
```{r}
samples_height_model <- sample_n(posterior_table,size=10000,weight=posterior,replace=TRUE)  %>% # sample from your grid approximation posterior
  select(mu,sigma)
```
